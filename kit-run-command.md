...
| 항목 | 값 | 비고 |
|------|-----|------|
| `--ext-folder` | `C:/Users/<you>/workspace/Isaac-sim-MCP/kkr-extensions` | 모든 profile 동일 |
...
& "C:/Users/<you>/workspace/branch/isaac-sim-standalone-5.1.0-windows-x86_64/kit/kit.exe" `
  ...
  --ext-folder "C:/Users/<you>/workspace/Isaac-sim-MCP/kkr-extensions" `
...
- `[settings.app.exts.folders] '++'` 배열에 `"C:/Users/<you>/workspace/Isaac-sim-MCP/kkr-extensions"` 추가
...
- **ext-folder 가 절대경로** (`C:/Users/<you>/workspace/Isaac-sim-MCP/kkr-extensions`) → 프로젝트를 옮기면 `.kit` 도 함께 갱신
