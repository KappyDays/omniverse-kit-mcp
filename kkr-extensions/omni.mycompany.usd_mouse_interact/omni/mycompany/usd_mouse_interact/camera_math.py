...
def update_yaw_pitch(
    ...
    Convention: dx > 0 (mouse right) → camera turns right (yaw decreases for
    right-handed Y-up looking down -Z, but we pick a sign that feels natural in
    Kit and stays consistent with basis_from_yaw_pitch below).
    """
