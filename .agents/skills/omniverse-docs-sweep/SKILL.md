...
- `.Codex/skills/omniverse-kit-extension-catalog-sync/SKILL.md` — isomorphic patterns reference
- `.Codex/skills/omniverse-asset-inventory-sync/SKILL.md` — isomorphic patterns reference
