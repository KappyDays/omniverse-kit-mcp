...
- **(3a) 카운터**:
  - tool 수: `grep -c '@mcp.tool()' src/omniverse_kit_mcp/tools/*.py` 합산 → root `CLAUDE.md` / `README.md` 의 수치 확인
...
- **라인캡**: 루트 `CLAUDE.md` ≤150 / sub-CLAUDE.md ≤150 / `docs/invariants/*.md` ≤200 / `docs/runbooks/*.md` ≤300 — 하나라도 초과 시 후보 폐기
