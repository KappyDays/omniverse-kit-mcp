...
- MCP tool 카탈로그 + 도메인 caveat: `../src/omniverse_kit_mcp/tools/CLAUDE.md`, `../src/omniverse_kit_mcp/modules/integration-facts.md`
- Character 제약 + Asset URL 카탈로그: `../src/omniverse_kit_mcp/modules/CLAUDE.md`, `../docs/assets/isaac/asset_inventory.md`
