...
- 도메인별 런타임 함정: `../src/isaacsim_mcp/modules/integration-facts.md`
- MCP tool 시그니처: `../src/isaacsim_mcp/tools/CLAUDE.md`
...
- `action` 매핑 규약: `../src/isaacsim_mcp/scenario/CLAUDE.md` 의 action_registry
...
| `robot` / `character` | 도메인 tool (load / navigate / joints / play_animation 등) | R2 (playing 필수) + 자세한 caveat: `../src/isaacsim_mcp/tools/CLAUDE.md` |
...
AnimGraph / NavMesh / shutdown hang 상세는 `../src/isaacsim_mcp/modules/CLAUDE.md §"Character domain constraints"` + `../docs/invariants/scenario-validation.md §"Character 표준 sequence"`. YAML 관점 체크리스트:
...
3. 새 action 이 필요하면 `../src/isaacsim_mcp/scenario/CLAUDE.md §"새 action 추가 flow"` + `../docs/invariants/module-add.md`
...
- MCP tool 카탈로그 + 그룹별 caveat: `../src/isaacsim_mcp/tools/CLAUDE.md`
- 도메인 런타임 제약 (15 도메인): `../src/isaacsim_mcp/modules/integration-facts.md`
- Character 제약 (AnimGraph/NavMesh 실측): `../src/isaacsim_mcp/modules/CLAUDE.md`
- Asset URL 카탈로그: `../isaac_course/docs/asset_inventory.md`
