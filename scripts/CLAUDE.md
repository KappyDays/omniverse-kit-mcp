...
| `diff_asset_inventory.py` | `docs/assets/isaac/assets/*.md` 의 모든 USD/USDA URL 을 NVIDIA S3 에 HTTP HEAD 검증. 404 / NET / 5xx 보고 | Asset 경로 fail 보고 시 또는 Isaac Sim 6.x / SimReady asset bucket 갱신 후 — workflow 는 `/omniverse-asset-inventory-sync` skill |
