...
- Source checkout: `C:\Users\kang\workspace\omniverse-kit-mcp`
- Current source branch: `main`
- Source checkout has dirty/untracked work. Treat those changes as user-owned
  unless this document explicitly says otherwise.
- Previous execution worktree `C:\Users\kang\.codex\worktrees\15aa` is no
  longer present in `git worktree list` or on disk. Do not rely on any files
  that were said to exist only in that worktree.
- This document is currently the durable restart anchor for the upgrade.
- Do not commit, push, stage, or create PRs unless the user explicitly asks.

Current implementation worktree:

```text
Path: C:\Users\kang\.codex\worktrees\isaac6-live\omniverse-kit-mcp
Branch: codex/isaac-sim-6-live-upgrade
Baseline SHA: e9039e0c3719a8923f31d3b8560d558af3ce276b
Status: complete; static gates and required Isaac Sim 6.0 live gates passed.
...
```dotenv
ISAAC_SIM_KIT_EXE=C:/Users/kang/workspace/branch/isaac-sim-standalone-6.0.0-windows-x86_64/kit/kit.exe
ISAAC_SIM_KIT_FILE=C:/Users/kang/workspace/branch/isaac-sim-standalone-6.0.0-windows-x86_64/apps/isaacsim.exp.full.kit
...
- [ ] Verify Isaac Python:
      ```powershell
      & "C:\Users\kang\workspace\branch\isaac-sim-standalone-6.0.0-windows-x86_64\python.bat" -c "import sys; print(sys.version); print(sys.executable)"
      ```
...
| 2026-06-10 | previous-worktree-missing | `git worktree list` shows only source checkout; `C:\Users\kang\.codex\worktrees\15aa` is absent. Reconstruct upgrade in a fresh worktree. |
...
| 2026-06-10 | worktree-created | Implementation worktree `C:\Users\kang\.codex\worktrees\isaac6-live\omniverse-kit-mcp` on branch `codex/isaac-sim-6-live-upgrade`, baseline `e9039e0c3719a8923f31d3b8560d558af3ce276b`. |
...
| 2026-06-10 | live-kit-green | Local 6.0 standalone started from `C:\Users\kang\workspace\branch\isaac-sim-standalone-6.0.0-windows-x86_64` with `kit.exe` + `apps/isaacsim.exp.full.kit`; instance 1 ready on port 8111. |
