# Isaac Sim 5.1 — Asset Catalog Index

**실측 완료**: 2026-04-23 live Isaac Sim 5.1 + S3 전수 조회.  
...
| 카탈로그 | Bucket | Prefix |
|---|---|---|
| **Isaac Sim Assets** | `omniverse-content-production.s3-us-west-2.amazonaws.com` | `Assets/Isaac/5.1/Isaac/` |
...
| 사람 / 캐릭터 / 애니메이션 | `docs/assets/people.md` | Named Characters 18종 · DH_Characters · Animations 24종 |
