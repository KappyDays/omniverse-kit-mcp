...
- `.\.venv\Scripts\python.exe -m pytest tests\unit\test_standalone_scripts.py::test_mcp_probe_main_rejects_live_assertions_without_live_mode tests\unit\test_standalone_scripts.py::test_mcp_probe_main_wires_live_assertion_options -q`
  passed: `9 passed in 0.69s`.
