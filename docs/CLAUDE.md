...
| `runbooks/` | **Failure-response pull-docs** — kit-stdin-deadlock / cold-boot-timeout / hub-orphan / env-sub-config / kit-dep-solver-fail / multi-app / scene-reexport-lock / public-history-leak: 8 files. Ignored in normal development flow, referenced only in case of failure | Hard cap ≤300 lines. Add new failure types here |
